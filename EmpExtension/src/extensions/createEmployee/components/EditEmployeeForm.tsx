...
export interface IEditEmployeeState {
    selectedDept: any;
...
export default class EditEmployeeForm extends React.Component<ICreateEmployeeProps, IEditEmployeeState, any> {
    ...
    constructor(props: ICreateEmployeeProps) {
        ...
        this.state = ({
            selectedDept: "",
            selectedDeptText: "",
            selectedDeptKey: props.Department,
            selectedDesigKey: props.Designation,
            selectedDesigText: "",
            designationDetails: [],
            selectedQualiKey: props.Qualification,
            selectedQualiText: "",
            qualificationDetails: [],
            selectedLocaKey: props.Location,
            selectedLocaText: "",
            locationDetails: [],
            selectedROKey: props.ReportingOfficer,
            selectedROText: "",
            reportingOfficerDetails: [],
            selectedNatKey: props.Nationality,
            selectedNatText: "",
            nationalityDetails: [],
            birthdate: props.DateOfbirth,
            joindate: props.DateofJoining,
            firstname: props.Firstname,
            selectedgender: props.Gender,
            lastName: props.Lastname,
            mobile: props.MobileNo,
            email: props.EmailId,
            alterEmail: props.AlternativeEmail,
            alterPhone: props.AlternativePhone,
            workPhone: props.WorkPhone,
            perAddress: props.PermanentAddress,
            temAddress: props.TemporaryAddress,
            country: props.Country,
            city: props.City,
            state: props.State,
            pin: props.PIN,
            passport: props.PassportDetails,
            idProof: props.IDProofDetails,
            license: props.DrivingLicense,
            address: props.Address,
            userNameId: props.Usernameid,
            repotingOfficerKey: props.ReportingOfficer,
            userEmail: "",
            empid: "",
        ...
        this._onUpdateEmployee = this._onUpdateEmployee.bind(this);
    ...
    private _onAddressChecked = (ev: React.FormEvent<HTMLInputElement>, isChecked?: boolean) => {
        if (isChecked) {
            this.setState({ temAddress: this.props.permanentaddress });
        }
        else {
    ...
    private _onUpdateEmployee = async () => {
        ...
        if (this.validator.fieldValid("firstname") && this.validator.fieldValid("lastName") && this.validator.fieldValid("joindate")
            ...
            sp.web.getList("sites/CCSHR/Lists/Employees").items.getById(this.state.itemId).update(
                {
    ...
    public render(): React.ReactElement<ICreateEmployeeProps> {
        ...
        return (
            <Panel isOpen={isOpen} type={PanelType.custom}
                ...
                <IconButton iconProps={{ iconName: "PeopleAdd" }} title="Add Employee" label="Add New Employee" ></IconButton>
                <div>
                    <Pivot aria-label="Large Link Size Pivot Example">
                        <PivotItem headerText="Personal">
                            ...
                            <PeoplePicker
                                ...
                                defaultSelectedUsers={[this.props.Usernameid]}
                            ...
                            <div style={{ color: "#dc3545" }}>{this.validator.message("noticePeriod", this.state.noticePeriod, "required|")}{" "}</div>
                        </PivotItem>
                        <PivotItem headerText="Address">
                            ...
                            <br></br>
                            {/* <Checkbox label="Same as Permanent Address " checked={true} onChange={this._onAddressChecked} /> */}
                ...
                <div style={{ display: this.state.EmployeeAdded }}>
                    <MessageBar messageBarType={MessageBarType.success} isMultiline={false}> Employee details updated.</MessageBar>
                </div>
                <DialogFooter>
                    <PrimaryButton text="Save" onClick={this._onUpdateEmployee} />
